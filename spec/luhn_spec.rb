...
RSpec.describe Luhn, type: :model do
	describe 'is_valid? should work' do
		...
		# these test confirm the code is starting on the right side, not the left

		it "should return true if the number is valid and the number has an odd numbers of digits" do
